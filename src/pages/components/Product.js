...
const Product = () => {
  ...
  return (
    <Layout>
      <div className='grid  grid-rows-[250px] md:grid-rows-[420px_1fr] p-4 grid-cols-1 md:grid-cols-[2fr_1fr] mt-20 '>
        <div className=' row-span-1 col-span-1 flex justify-center '>
          <iframe className='w-96 md:w-[660px] h-[220px] md:h-[420px]' src={`https://www.youtube.com/embed/${router.query.id}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        </div>
