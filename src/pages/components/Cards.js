...
const Cards = (props) => {
   ...
   const router = useRouter()
    return (
        <div key={props.keys} className='h-[300px] w-[380px] flex  flex-col items-center bg-white bg-opacity-25 bg-blend-saturation  rounded-lg text-black font-bold  gap-2 shadow-xl '>
